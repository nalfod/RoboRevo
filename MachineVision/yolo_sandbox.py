...
button_collection = {
    ...
    "j": Button(7, 2), "k": Button(8, 2), "l": Button(9, 2), "ae": Button(10, 2), "aa": Button(11, 2), "uee": Button(13, 2), "Numpad4": Button(14, 2),
    "Numpad5": Button(15, 2), "Numpad6": Button(16, 2),
    ...
    "Control": Button(0, 4), "Windows": Button(1, 4), "Alt": Button(2, 4), "Space": Button(3, 4), "AltGr": Button(5, 4), "fn": Button(6, 4), "ControlR": Button(7, 4),
    "ArrowDown": Button(8, 4), "ArrowLeft": Button(9, 4), "ArrowRight": Button(10, 4), "Numpad0": Button(11, 4), "NumpadDel": Button(12, 4)
}
